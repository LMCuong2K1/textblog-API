...
const postController = {
    ...
    getAllPosts: async (req, res) => {
        try {
            // aqp có thể đưa 'page' vào trong 'filter'.
            // Chúng ta sẽ xử lý nó thủ công để đảm bảo phân trang hoạt động chính xác.
            ...
            // Xóa 'page' khỏi filter để nó không bị coi là một tiêu chí tìm kiếm trong DB.
